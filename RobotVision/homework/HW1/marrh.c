...
{
    char *foobar, fileName[50], fileName1[50], fileName2[50];
    ...
    argc--;
    char *outfile = *(++argv);
    sprintf(fileName,"%s%s",outfile,"mag.pgm");
    fo1 = fopen(fileName,"wb");
    printf("File output: %s\n", fileName);

    argc--;
    sprintf(fileName1,"%s%s",outfile,"peaks.pgm");
    fo2 = fopen(fileName1,"wb");
    printf("File output: %s\n", fileName1);

    argc--;
    sprintf(fileName2,"%s%s",outfile,"final.pgm");
    fo3 = fopen(fileName2, "wb");
    printf("File output: %s\n", fileName2);
